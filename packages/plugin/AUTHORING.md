...
- Claude Code: the plugin/marketplace (see README). Claude Desktop / claude.ai: an owner provisions
  the zips org-wide (Organization → Skills; per-user zip upload also works) + the org connector — see
