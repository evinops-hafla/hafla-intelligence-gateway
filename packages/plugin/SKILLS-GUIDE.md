...
| You are…       | On…                                  | Do this                                                                                                                                                                                                                                                                                                                                                                                |
| -------------- | ------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Sales / CX** | **Claude Desktop / claude.ai**       | **Live — production GA (2026-09-05).** Connect the **EvWA Intelligence** connector (your admin adds it org-wide; if your workspace permits, you can add the URL `https://mcp.hafla.com/mcp` yourself — it self-registers, no client ID/secret), sign in with Google `@hafla.com`. The six skills are provisioned org-wide by your admin (enabled by default — nothing to upload; check Customize → Skills). Full steps: [`DESKTOP-SETUP.md`](DESKTOP-SETUP.md). |
